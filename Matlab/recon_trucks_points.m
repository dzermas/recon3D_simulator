...
I1 = '../../data/trucks/simulations/sim_truck_02.png';
I2 = '../../data/trucks/simulations/sim_truck_03.png';
...
camera1.fc = [621.6 621.6];
camera1.kc = [0 0 0 0 0];
camera1.cc = [ 253; 450 ];
camera1.alpha_c = 0;

camera2.fc = [621.6 621.6];
camera2.kc = [0 0 0 0 0];
camera2.cc = [ 253; 450 ];
camera2.alpha_c = 0;
